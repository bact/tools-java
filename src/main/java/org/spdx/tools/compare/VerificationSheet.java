...
public class VerificationSheet extends AbstractSheet {
	...
	public void importVerificationErrors(
		...
		for (int i = 0; i < docNames.size(); i++) {
			...
			hCell.setCellValue(docNames.get(i));
			List<String> errors = verificationErrors.get(i);
			if (errors != null) {
